...
export function deckLessonMarkup(section){
 ...
 <g class="composition-card"><g class="deck-trailing"><rect x="167" y="153" width="70" height="94" rx="4" fill="#090C12" stroke="#FFD166" transform="rotate(-9 200 200)"/><rect x="164" y="151" width="70" height="94" rx="4" fill="#12161B" stroke="#45D6C5" transform="rotate(7 200 200)"/></g><rect x="164" y="150" width="70" height="94" rx="4" fill="#FE0040"/>
