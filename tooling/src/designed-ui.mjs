...
<div id="design-workspace">
  <div class="design-intro"><div><h2>Designed archetypes</h2><p>Two-color cores. Shared cards. Clear rewards.</p></div><a class="primer-link" href="/primer">First draft? Start here &rarr;</a></div>
